...
xcodebuild -workspace ./ModularDemoApp.xcworkspace -scheme ModularDemoApp -clonedSourcePackagesDirPath SourcePackages -sdk iphoneos -configuration AdHoc archive -archivePath $BITRISE_SOURCE_DIR/build/ModularDemoApp.xcarchive
